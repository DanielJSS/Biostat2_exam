...
![Multiple regression model output](images/multiple regression output.JPG)
...
![residual vs. fitted values](Residual vs fitted value (task4).png)

![Q-Q plot](Normal q-q plot.png)

![Normal Q-Q plot w/line](normal q-q plot with line.png)

![Heteroscedasticity](Heteroscedasticity lm model (taks 4).png)
...
![Species richness predictions at different temperatures](images/speceis richness predictions.JPG)
...
![Speciess richness at differing temperatures](Speciess richenss at different temperatures figure.png)
...
![Table of speciess richness at differing temperatures](table species richness at different temperatures.JPG)
